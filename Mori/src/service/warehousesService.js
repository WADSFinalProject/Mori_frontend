...
export const getAllWarehouses = async (skip = 0, limit = 100) => {
    try {
        ...
        return await axios.get("https://mori-backend.vercel.app/secured/warehouses", {
            headers: {
...
export const createWarehouse = async (PIC_name, email, phone) => {
    try {
        ...
        return await axios.post("https://mori-backend.vercel.app/secured/warehouses", warehouseDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const getWarehouseDetails = async (warehouse_id) => {
    try {
        return await axios.get(`https://mori-backend.vercel.app/secured/warehouses/${warehouse_id}`, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const updateWarehouse = async (warehouse_id, PIC_name, email, phone) => {
    try {
        ...
        return await axios.put(`https://mori-backend.vercel.app/secured/warehouses/${warehouse_id}`, warehouseDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const deleteWarehouse = async (warehouse_id) => {
    try {
        return await axios.delete(`https://mori-backend.vercel.app/secured/warehouses/${warehouse_id}`, {
            headers: {
                "Content-Type": "application/json",
            },
        });
