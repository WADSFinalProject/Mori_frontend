...
export const addShipment = async (batch_id, description, status, weight, issue_description) => {
    try {
        ...
        return axios.post("https://mori-backend.vercel.app/secured/shipments", shipmentDetails, {
            headers: {
...
export const readShipments = async (skip = 0, limit = 100) => {
    try {
        return axios.get("https://mori-backend.vercel.app/secured/shipments", {
            params: {
                skip: skip,
                limit: limit,
            },
...
export const updateShipment = async (shipment_id, batch_id, description, status, weight, issue_description) => {
    try {
        ...
        return axios.put(`https://mori-backend.vercel.app/secured/shipments/${shipment_id}`, shipmentDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const getShipmentDetails = async (shipment_id) => {
    try {
        return axios.get(`https://mori-backend.vercel.app/secured/shipments/${shipment_id}`, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const deleteShipment = async (shipment_id) => {
    try {
        return axios.delete(`https://mori-backend.vercel.app/secured/shipments/${shipment_id}`, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const confirmShipmentArrival = async (shipment_id, weight) => {
    try {
        ...
        return axios.post(`https://mori-backend.vercel.app/secured/shipments/${shipment_id}/confirm`, shipmentDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const reportShipmentIssue = async (shipment_id, description) => {
    try {
        ...
        return axios.post(`https://mori-backend.vercel.app/secured/shipments/${shipment_id}/report`, issueDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const rescaleShipment = async (shipment_id, new_weight) => {
    try {
        ...
        return axios.put(`https://mori-backend.vercel.app/secured/shipments/${shipment_id}/rescale`, weightDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
...
export const schedulePickup = async (pickup_time, location) => {
    try {
        ...
        return axios.post("https://mori-backend.vercel.app/secured/shipments/schedule-pickup", pickupDetails, {
            headers: {
                "Content-Type": "application/json",
            },
        });
