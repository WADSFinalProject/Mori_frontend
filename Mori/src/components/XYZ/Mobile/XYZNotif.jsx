            ...
            {isMobile ? (
                ...
                <div className="bg-white">
                    ...
                    <div>
                        ...
                        {/* Unopened card */}
                        <div className="m-5 relative rounded-lg" style={{ backgroundColor: "#F2F9A9" }}>
                            <div className="absolute top-4 right-4 h-4 w-4 rounded-full" style={{ backgroundColor: "#5C612C" }}></div>
                            <div className="flex flex-col items-start w-full">
                                <div className="relative">
                                    <div className="ml-6 mt-5" style={{ position: 'relative', width: '250px', height: '75px' }}>
                                        <p><strong>Package #ID</strong> has started</p>
                        ...
                        <div className="m-5 relative rounded-lg" style={{ backgroundColor: "#F2F9A9" }}>
                            ...
                            <div className="flex flex-col items-start w-full">
                                <div className="relative">
                                    <div className="ml-6 mt-5" style={{ position: 'relative', width: '250px', height: '90px' }}>
                                        <p><strong>Package #ID</strong> is being delivered by <strong>Franz Sinatra</strong></p>
                                        <p className="text-gray-500">
                                            <span>09:00 AM -</span>
                                            <span> 2 minutes ago</span>
                                        </p>
                        ...
                        <div className="m-5 relative rounded-lg" style={{ backgroundColor: "#EFEFEF" }}>
                            ...
                            <div className="flex flex-col items-start w-full">
                                <div className="relative">
                                    <div className="ml-6 mt-5" style={{ position: 'relative', width: '250px', height: '75px' }}>
                                        <p><strong>Package #ID</strong> has been confirmed</p>
                                        <p className="text-gray-500">
                                            <span>09:00 AM -</span>
                                            <span> 2 minutes ago</span>
                                        </p>                                
