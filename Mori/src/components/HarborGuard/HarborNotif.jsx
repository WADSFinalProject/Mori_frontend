        ...
        <div className="bg-white mt-5">
          ...
          <div>
            ...
            <div
              ...
              style={{ backgroundColor: "#CDE8D9" }}
            >
              <div
                className="absolute top-4 right-4 h-4 w-4 rounded-full"
                style={{ backgroundColor: "#5D9EA4" }}
              ></div>
              <div className="flex flex-col items-start w-full">
                <div className="relative">
                  <div
                    className="ml-6 mt-5 mb-3"
                    style={{
                      position: "relative",
                      width: "250px",
                      height: "75px",
            ...
            >
              ...
              <div className="flex flex-col items-start w-full">
                <div className="relative">
                  ...
                  >
                    <p>
                      <strong>Package #ID</strong> is being delivered by Franz
                      Sinatra
                    </p>
                    <p className="text-gray-500">
                      <span>09:00 AM -</span>
            ...
            >
              ...
              <div className="flex flex-col items-start w-full">
                <div className="relative">
                  ...
                  >
                    <p>
                      <strong>Package #ID</strong> has been declared missing
                    </p>
                    <p className="text-gray-500">
                      <span>09:00 AM -</span>
                      <span> 2 minutes ago</span>
