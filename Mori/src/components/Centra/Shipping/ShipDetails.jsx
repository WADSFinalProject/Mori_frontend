...
export default function ShipDetails() {
    ...
    const [shipmentState, setShipmentState] = useState('Missing'); // Default state is 'Shipped'
                    ...
                    {shipmentState === 'Shipped' && (
                        <>
                            <div className="p-3 shadow-md flex items-start" style={{ backgroundColor: '#B4E0CC' }}>
                                <img src={packIcon} alt="Package" className="w-6 h-6 mr-2 " style={{ color: '#000000' }} />
                                ...
                                <div className="flex">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center">
                                            <img src={greenpoint} alt="Red Point" className="w-3 h-7 mr-2" />
                    ...
                    {shipmentState === 'Delivering' && (
                        <>
                            <div className="p-3 shadow-md flex items-start" style={{ backgroundColor: '#4D946D' }}>
                                <img src={GreenTruck} alt="Package" className="w-6 h-5 mr-2 " style={{ color: '#000000' }} />
                                <div className="flex flex-col justify-between">
                                    ...
                                    <p className="text-xs lg:text-sm font-vietnam" style={{ color: '#F0F0F0' }}>Shipped with {delivService}</p>
                                </div>
                            </div>
                            <div className="p-3 shadow-md" style={{ backgroundColor: '#ffffff' }}>
                                <div className="flex">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center">
                                            <img src={darkgreenpoint} alt="Red Point" className="w-3 h-7 mr-2" />
                                            <div className="flex flex-col">
                    ...
                    {shipmentState === 'Missing' && (
                        <>
                            <div className="p-3 shadow-md flex items-start" style={{ backgroundColor: '#CD484870' }}>
                                <img src={RedTruck} alt="Package" className="w-6 h-5 mr-2 " style={{ color: '#000000' }} />
                                <div className="flex flex-col justify-between">
