    ...
    <div className="max-w-[425px] mx-auto h-screen flex flex-col items-start justify-start bg-white">
      ...
      <main className="flex flex-col w-full">
        ...
        <div className="flex flex-col font-vietnam p-5">
          ...
          <div className="mt-3 mb-2 flex flex-col w-full gap-1">
            <div className="flex flex-row justify-between">
              <div className="font-bold text-sm">Batch #10201</div>
              <div className="font-bold text-sm text-[#5D9EA4]">{23} kg</div>
            </div>
          ...
          <div className="flex flex-row my-3 justify-between font-bold text-sm">
            ...
            <div className="text-[#5D9EA4]">72.3 kg</div>
          </div>
        </div>
      </main>
    </div>
