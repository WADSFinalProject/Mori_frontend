...
const CollectorMain = () => {
  ...
  const totalWeight = batchData.reduce((total, batch) => total + (parseFloat(batch.weight) || 0), 0);
  ...
  return (
    <div className="collector-main-container h-screen bg-[#F0F0F0] overflow-hidden flex flex-col items-start justify-start pt-[18px] px-0 pb-0 box-border gap-[24px] leading-[normal] tracking-[normal] ml-auto mr-auto overflow-y-auto">
      ...
      <header className="self-stretch flex flex-col items-start justify-start gap-[24px] max-w-full text-left text-base text-black font-vietnam">
        <nav className="m-0 self-stretch flex flex-row items-center justify-between py-0 pr-6 pl-5 box-border max-w-full">
          <div className="flex flex-row items-center justify-start gap-[20px]">
            <h3 className="m-0 relative text-[22px] tracking-[-0.02em] font-bold font-inherit inline-block min-w-[28px]">
              <a href="centranavigation">
                <svg
          ...
          <div className="flex flex-1 flex-row items-center justify-center">
            <h3 className="m-0 relative text-inherit font-bold font-vietnam text-gray-950 text-center inline-block min-w-[89px]">
              Collectors
            </h3>
          </div>

          <div className="flex flex-row items-center justify-end gap-[15px] text-left text-black">
