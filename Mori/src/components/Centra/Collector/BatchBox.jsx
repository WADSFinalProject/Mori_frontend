...
<div className="relative">
    <div className="bottom-8 right-0.5 relative w-[108px] h-[27px] px-10 py-2 rounded justify-center items-center gap-2.5 inline-flex" style={{ backgroundColor: status === 'Expired' ? '#D9D9D9' : getDurationColor(duration), color: status === 'Expired' ? '#FFFFFF' : '' }}>
        {/* SVG positioned absolutely */}
        <svg className="absolute top-[7px] left-2 w-3 h-3" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {isEditing && <EditBatch onClose={() => setIsEditing(false)} />}
    </div>
  );
};
