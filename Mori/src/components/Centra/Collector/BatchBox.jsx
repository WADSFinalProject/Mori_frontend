...
const BatchBox = ({ batchId, status, date, time, weight, duration, selectedDate }) => {
  ...
  return (
    <div className="self-stretch rounded-2xl overflow-hidden flex flex-col items-start justify-start p-4 pb-0.5 gap-[14px]" style={{ backgroundColor: 'white' }}>
      ...
      {/* Status Conditions */}
      {status === 'Exceeded' && (
        <div className="mb-[-5px] mt-[-15px] flex items-center"> {/* Use flex container */}
...
<div className="relative">
  ...
  <EditBatch
    ...
    batchData={{ batchId, status, date, time, weight, duration }}
  />
)}
