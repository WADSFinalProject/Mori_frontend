...
import { getConversionRates } from "../../service/dashboard";
...
const DashboardContent = () => {
  const [selectedConversionRate, setSelectedConversionRate] = useState(
    conversionRates[0]
  );
  const [conversionRateDropdownVisible, setConversionRateDropdownVisible] =
    useState(false);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const expeditionIDs = expeditions.data.map(
          (item) => item.expedition.ExpeditionID
        );
    ...
    const fetchConversionRates = async () => {
      try {
        ...
        if (data.length > 0) {
          setSelectedConversionRate(data[0]);
        }
      } catch (error) {
    ...
    datasets: [
      {
        data: [
          ...
          100 - selectedConversionRate.conversionRate,
        ],
              ...
              <div className="flex items-center justify-center h-full">
                <div className="relative w-48 h-48">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center mt-20">
                    ...
                    <span className="text-[#A7AD6F] text-lg">
                      ^ {selectedConversionRate.rateChange}%
                    </span>
                  </div>
                </div>
              </div>
              <div className="flex mt-3 flex-wrap">
                <div className="flex items-center mr-4">
                  ...
                  <span className="text-gray-700">
                    {selectedConversionRate.wetToDry}% Wet to Dry Leaves
                  </span>
                </div>
                <div className="flex items-center mr-4">
                  <span className="inline-block w-3 h-3 bg-[#4D946D] rounded-full mr-2"></span>
                  <span className="text-gray-700">
                    {selectedConversionRate.dryToFloured}% Dry to Floured Leaves
                  </span>
                </div>
              </div>
            </div>
