...
import CentraDetailsMachine from '../CentraDetailsMachine';
  ...
  return (
    <div className="relative">
      ...
      {isCentraDetailsVisible && (
        <div style={{ width: "87vw" }} className="fixed top-0 right-0 h-full bg-white z-50 overflow-auto">
          <div className="p-4">
          <button onClick={handleClose} className="mb-4 flex items-center gap-2 px-5 py-3 bg-gray-200 text-gray-700 font-bold rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                viewBox="0 0 20 20"
